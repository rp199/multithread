package com.rp199.reetrantlock.productreviews;
...
public class ProductReviewsService {
    ...
    private ReentrantReadWriteLock productsLock = new ReentrantReadWriteLock();
